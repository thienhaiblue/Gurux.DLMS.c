...
* Constructor.
*/
extern void CGXDLMSConnectionEventArgs_(CGXDLMSConnectionEventArgs *p);

extern int CGXDLMSConnectionEventArgs_GetServerAddress(CGXDLMSConnectionEventArgs *p);

extern void CGXDLMSConnectionEventArgs_SetServerAddress(CGXDLMSConnectionEventArgs *p, int value);
