...
const char* CGXDLMSConverter_GetErrorMessage(int error)
{
    switch (error)
    {
...
const char* CGXDLMSConverter_ToString_1(DLMS_BAUD_RATE value)
{
    switch (value)
    {
    case 0:
...
const char* CGXDLMSConverter_ToString_3(DLMS_CLOCK_STATUS value)
{
    switch (value)
    {
    case 0:
...
const char* CGXDLMSConverter_ToString_2(DLMS_CLOCK_BASE value)
{
    switch (value)
    {
    case 0:
...
const char* CGXDLMSConverter_GetUnitAsString(int unit)
{
    switch (unit)
    {
    case 0:
...
const char* CGXDLMSConverter_ToString_4(DLMS_ADDRESS_STATE value)
{
    switch (value)
    {
    case 0:
...
const char* CGXDLMSConverter_ToString_5(DLMS_CONTROL_STATE value)
{
    switch (value)
    {
    case 0:
...
const char* CGXDLMSConverter_ToString_6(DLMS_CONTROL_MODE value)
{
    switch (value)
    {
    case 0:
...
const char* CGXDLMSConverter_ToString_7(DLMS_SECURITY_POLICY value)
{
    switch (value)
    {
...
const char* CGXDLMSConverter_ToString_8(DLMS_SECURITY_SUITE value)
{
    switch (value)
    {
...
const char* CGXDLMSConverter_ToString_9(DLMS_DLMS_ASSOCIATION_STATUS value)
{
    switch (value)
    {
...
const char* CGXDLMSConverter_ToString_10(DLMS_OPTICAL_PROTOCOL_MODE value)
{
    switch (value)
    {
...
const char* CGXDLMSConverter_ToString_11(DLMS_LOCAL_PORT_RESPONSE_TIME value)
{
    switch (value)
    {
...
const char* CGXDLMSConverter_ToString_12(DLMS_GSM_STATUS value)
{
    const char* str;
    switch (value)
    {
...
const char* CGXDLMSConverter_ToString_13(DLMS_GSM_CIRCUIT_SWITCH_STATUS value)
{
    const char* str;
    switch (value)
    {
...
const char* CGXDLMSConverter_ToString_14(DLMS_GSM_PACKET_SWITCH_STATUS value)
{
    const char* str;
    switch (value)
    {
