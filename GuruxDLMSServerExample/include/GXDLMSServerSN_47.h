...
#ifndef GXDLMSSERVERSN_47_H_
#define GXDLMSSERVERSN_47_H_

#include "GXDLMSBase.h"

typedef struct CGXDLMSServerSN_47 // class CGXDLMSServerSN_47 : public CGXDLMSBase
{
    ///////////////////////////////////////////////////////////////////////////
    // (CGXDLMSServer)
    long m_DataReceived;
...
#define CGXDLMSServerSN_47_Init(p, port, trace) CGXDLMSBase_Init((CGXDLMSBase*) (p), (port), (trace))
#define CGXDLMSServerSN_47_d(p)                 CGXDLMSBase_d((CGXDLMSBase*) (p))

//Constructor.
extern void CGXDLMSServerSN_47_(CGXDLMSServerSN_47* p,
                                CGXDLMSAssociationShortName* sn,
                                CGXDLMSTcpUdpSetup* wrapper)
{
    CGXDLMSBase_5((CGXDLMSBase*) p, sn, wrapper);
}
