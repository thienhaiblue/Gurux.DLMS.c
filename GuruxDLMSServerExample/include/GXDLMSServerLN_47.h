...
#ifndef GXDLMSSERVERLN_47_H_
#define GXDLMSSERVERLN_47_H_

#include "GXDLMSBase.h"

typedef struct CGXDLMSServerLN_47 // class CGXDLMSServerLN_47 : public CGXDLMSBase
{
    ///////////////////////////////////////////////////////////////////////////
    // (CGXDLMSServer)
    long m_DataReceived;
...
#define CGXDLMSServerLN_47_Init(p, port, trace) CGXDLMSBase_Init((CGXDLMSBase*) (p), (port), (trace))
#define CGXDLMSServerLN_47_d(p)                 CGXDLMSBase_d((CGXDLMSBase*) (p))

//Constructor.
extern void CGXDLMSServerLN_47_(CGXDLMSServerLN_47* p,
                                CGXDLMSAssociationLogicalName* ln,
                                CGXDLMSTcpUdpSetup* wrapper)
{
    CGXDLMSBase_3((CGXDLMSBase*) p, ln, wrapper);
}
