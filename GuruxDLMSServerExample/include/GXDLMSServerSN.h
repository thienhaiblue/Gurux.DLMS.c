...
#ifndef GXDLMSSERVERSN_H_
#define GXDLMSSERVERSN_H_

#include "GXDLMSBase.h"

typedef struct CGXDLMSServerSN // class CGXDLMSServerSN : public CGXDLMSBase
{
    ///////////////////////////////////////////////////////////////////////////
    // (CGXDLMSServer)
    long m_DataReceived;
...
#define CGXDLMSServerSN_Init(p, port, trace) CGXDLMSBase_Init((CGXDLMSBase*) (p), (port), (trace))
#define CGXDLMSServerSN_d(p)                 CGXDLMSBase_d((CGXDLMSBase*) (p))

//Constructor.
extern void CGXDLMSServerSN_(CGXDLMSServerSN* p,
                             CGXDLMSAssociationShortName* sn,
                             CGXDLMSIecHdlcSetup* hdlc)
{
    CGXDLMSBase_4((CGXDLMSBase*) p, sn, hdlc);
}
